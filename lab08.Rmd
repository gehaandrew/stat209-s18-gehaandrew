...
ggplot(mpg, aes(displ, hwy)) +
  ...
  ylab("Miles Per Gallon") +
  xlab("Engine Size") +
  ggtitle("City and Highway Miles Per Gallon for Various Engine Sizes")
...
I wasn't expecting so many votes for Hillary in the Deep South. Especially compared to farther north states.
